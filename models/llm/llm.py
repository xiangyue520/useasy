...
class UseasyLargeLanguageModel(LargeLanguageModel):
    tokenizers = {}
    ...
    def _generate(
        ...
        # Reference: https://help.useasy.cn/zh/model-studio/deep-thinking
        ...
        if ModelFeature.VISION in (model_schema.features or []):
            params["messages"] = self._convert_prompt_messages_to_useasy_messages(
    ...
    def _to_credential_kwargs(self, credentials: dict) -> dict:
        ...
        :return:
        """
        credentials_kwargs = {"api_key": credentials["useasy_api_key"]}
    ...
    def _convert_prompt_messages_to_useasy_messages(
        self,
        credentials: dict,
        prompt_messages: list[PromptMessage],
        ...
        """
        Convert prompt messages to useasy messages

        :param prompt_messages: prompt messages
        :return: useasy messages
        """
        useasy_messages = []
        for prompt_message in prompt_messages:
            if isinstance(prompt_message, SystemPromptMessage):
                useasy_messages.append(
                    {
                        "role": "system",
                        "content": (
                ...
                if isinstance(prompt_message.content, str):
                    ...
                    for message_content in prompt_message.content:
                        if message_content.type == PromptMessageContentType.TEXT:
                            ...
                            file_id = self._upload_file_to_useasy(
                    ...
                    useasy_messages.append({"role": "user", "content": user_messages})
                ...
                useasy_messages.append(message)
    ...
    def _handle_error_response(
        ...
        :param request_id: request id from Useasy API response (optional)
